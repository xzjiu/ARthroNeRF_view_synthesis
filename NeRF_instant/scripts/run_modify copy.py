...
def parse_args():
	...
	parser.add_argument("--calibration", default="C:/Users/camp/GIT/arthro_nerf/new_calibration_5/handeye_matrix.csv")
	parser.add_argument("--world_center", default="C:/Users/camp/GIT/arthro_nerf/NewPlatform1/world_center.pkl")
	# parser.add_argument("--post_R", default="C:/Users/camp/GIT/arthro_nerf/LEGO/postprocess-R.pkl")
	parser.add_argument("--post_info", default="C:/Users/camp/GIT/arthro_nerf/NewPlatform1/postprocess-info.pkl")
...
if __name__ == "__main__":
	...
	# 					# testbed.look_at = [center[0] + tran_vec[1]/289.13, center[1]+tran_vec[2]*0.0036754 , 0.5 + tran_vec[0]/313.7255]
	# 					#Set offset
	...
	# 					# For scale, test
	# 					# scale = 0.0031984*tran_vec[2] +0.014523
				...
				if args.gui and args.ndi:
					...
					if not np.isnan(tracking[0][0][-1]):
						...
						if toggle:
								...
								# print("initial: ", testbed.camera_matrix)
								testbed.look_at = [center[0] + tran_vec[1]/289.13, 0.5 + tran_vec[2]*0.0036754 , 0.5 + tran_vec[0]/313.7255]
							...
							# 	pass  # wait until 'k' is released to avoid rapid toggling
