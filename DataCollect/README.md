...
```
cd existing_repo
git remote add origin https://git.lcsr.jhu.edu/bigss/arthro_nerf.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.lcsr.jhu.edu/bigss/arthro_nerf/-/settings/integrations)
